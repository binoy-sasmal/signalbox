...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| gtfs_de | 351 | 201.5 | — | 65.9% | 0 | 178942 | — / — | — | — | — | **generation** | 0.0% |
...
Full analysis -> runs\run1b\analysis.json

[gtfs_de] header timestamp: generation — unanimous across 2 available test(s): C_async_repoll, E_http_date_last_modified
